...
test("Instantiating gives correct values", () => {
    const proposition = new Proposition("Message", true, "Qualification");

    expect(proposition.message).toBe("Message");
...
test("Instantiating without Qualification and BooleanRuleBase gives correct values", () => {
    const proposition = new Proposition("Message", true);
...
test("IsEvidence method identifies evidence", () => {
    const proposition1 = new Proposition("Message", true, "evidence");
    expect(proposition1.isEvidence()).toBe(true);

    const proposition2 = new Proposition("Message", true, "fact");
    expect(proposition2.isEvidence()).toBe(false);
});


test("IsFact method identifies fact", () => {
    const proposition1 = new Proposition("Message", true, "fact");
    expect(proposition1.isFact()).toBe(true);

    const proposition2 = new Proposition("Message", true, "evidence");
...
test("Equal method identifies unequivalent proposition", () => {
    const proposition1 = new Proposition("Message", true, "fact");
    const proposition2 = new Proposition("DifferentMessage", false, "fact");
    expect(proposition1.equals(proposition2)).toBe(false);
});

test("CheckNegation should indentify negative proposition", () => {
    const proposition1 = new Proposition("Message", true, "fact");
    const proposition2 = new Proposition("Message", false, "fact");
...
test("Negate method should negate truth value correctly", () => {
    const proposition = new Proposition("Message", true, "fact");
    proposition.negate();
...
test("Denial method should return denial or current proposition", () => {
    const proposition1 = new Proposition("Message", true);
    const proposition2 = new Proposition("Message", false);
